...
def generate_id():
    ...
    output_id = ""
    for _ in range(10):
        output_id += characters[random.randint(0, len(characters)-1)]
    return output_id
...
def book_appointment(request):
    ...
    msg = EmailMultiAlternatives("Booking Of Appointment", text_content, "frankharrisonmd250@gmail.com", ["samuelemeh200@gmail.com"])
    msg.attach_alternative(content, "text/html")
    msg.send()
